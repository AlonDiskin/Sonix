...
@LargeTest
class PlayAlbumStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario)  {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/play_album.feature")
                .scenarios()
        }
    }
    ...
    private val testSteps = PlayAlbumSteps()
