...
@LargeTest
class PlayTrackStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario)  {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/play_track.feature")
                .scenarios()
        }
    }
    ...
    private val testSteps = PlayTrackSteps()
