...
import static com.diskin.alon.sonix.common.exoplayertestutil.FakeSampleStream.FakeSampleStreamItem.END_OF_STREAM_ITEM;
import static com.diskin.alon.sonix.common.exoplayertestutil.FakeSampleStream.FakeSampleStreamItem.oneByteSample;
...
import com.diskin.alon.sonix.common.exoplayertestutil.FakeSampleStream.FakeSampleStreamItem;
...
public class FakeMediaPeriod implements MediaPeriod {
  ...
  public interface TrackDataFactory {
    ...
    /**
     * Returns the list of {@link FakeSampleStreamItem}s that will be written the
