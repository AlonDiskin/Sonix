...
import static com.diskin.alon.sonix.common.exoplayertestutil.FakeMediaPeriod.*;
...
public class FakeMediaSource extends BaseMediaSource {
  ...
  @Nullable private final TrackDataFactory trackDataFactory;
  ...
  public FakeMediaSource(
      ...
      @Nullable TrackDataFactory trackDataFactory,
      Format... formats) {
   ...
   * TrackDataFactory}. The provided {@link Timeline} may be null to prevent an
