 ...
 */
package com.diskin.alon.sonix.common.exoplayertestutil;

import static com.diskin.alon.sonix.common.exoplayertestutil.Action.*;
...
public final class ActionSchedule {
  ...
  public static final class Builder {
    ...
    public Builder setMediaSources(int mediaItemIndex, long positionMs, MediaSource... sources) {
      return apply(new SetMediaItems(tag, mediaItemIndex, positionMs, sources));
    }
    ...
    public Builder setMediaSources(boolean resetPosition, MediaSource... sources) {
      return apply(new SetMediaItemsResetPosition(tag, resetPosition, sources));
    }
    ...
    public Builder addMediaSources(MediaSource... mediaSources) {
      return apply(new AddMediaItems(tag, mediaSources));
    }
    ...
    public Builder moveMediaItem(int currentIndex, int newIndex) {
      return apply(new MoveMediaItem(tag, currentIndex, newIndex));
    }
    ...
    public Builder removeMediaItem(int index) {
      return apply(new RemoveMediaItem(tag, index));
    }
    ...
    public Builder removeMediaItems(int fromIndex, int toIndex) {
      return apply(new RemoveMediaItems(tag, fromIndex, toIndex));
    }
    ...
    public Builder clearMediaItems() {
      return apply(new ClearMediaItems(tag));
    }
    ...
    /**
     * Schedules a delay until a message arrives at the {@link Target}.
     *
   ...
   *
   * <p>The target can be passed to {@link Builder#waitForMessage(PlayerTarget)} to
