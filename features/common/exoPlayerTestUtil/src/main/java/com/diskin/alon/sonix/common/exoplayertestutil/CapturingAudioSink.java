...
import static com.diskin.alon.sonix.common.exoplayertestutil.Dumper.*;
...
public final class CapturingAudioSink extends ForwardingAudioSink implements Dumpable {

  private final List<Dumpable> interceptedData;
  ...
  private static final class DumpableConfiguration implements Dumpable {
  ...
  private static final class DumpableBuffer implements Dumpable {
  ...
  private static final class DumpableDiscontinuity implements Dumpable {
