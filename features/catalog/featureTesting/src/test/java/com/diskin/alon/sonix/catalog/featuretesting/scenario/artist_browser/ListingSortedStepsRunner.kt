...
@MediumTest
class ListingSortedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                .withFeatureFromAssets("feature/artist_browser.feature")
                .withTags("@listing-sorted")
                .scenarios()
    ...
    fun test() {
        ...
        start(ListingSortedSteps(contentResolver))
    }
}